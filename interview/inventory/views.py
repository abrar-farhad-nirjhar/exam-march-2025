...
class InventoryListCreateView(APIView):
    ...
    def get(self, request: Request, *args, **kwargs) -> Response:
        """ Initially ran database.py file within the django shell then 
        got results"""
        ...
        if after_date:
            date_filter = datetime.datetime.strptime(after_date, "%Y-%m-%d")
            queryset = queryset.filter(created_at__gte=date_filter.date())
